		...
		knex( "offices" ).insert([
			{
				...
				parentPath: "1",
				userID: 2,
				roles: JSON.stringify([ "user_read_private", "user_add", "user_update", "user_approve", "user_assign", "user_suspend", "org_update", "office_update", "office_assign", "office_create_assistants",
